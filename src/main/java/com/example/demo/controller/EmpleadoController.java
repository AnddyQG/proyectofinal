...
import com.example.demo.service.IBodegueroService;
...
public class EmpleadoController {
	...
	// 2a
		...
		public String pruebaInsertar(Bodeguero bodeguero) {
			
			this.bodegueroService.crear(bodeguero);
			return "vistaEmplConfirmacionB";
		}

		@GetMapping("/nuevoBodeguero")
		public String paginaNuevoBodeguer(Bodeguero bodeguero) {
			return "vistaEmplNuevoClienteB";
		}
